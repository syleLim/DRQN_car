...
class agent_car :
    ...
    def Train(self) :
        ...
        while True:
            ...
            self.cap = cv2.VideoCapture('site address')
            ...
            while not terminal:
                ...
                state, reward, terminal = game.Update(is_show, self.target_pos, self.obstacles_pos)
                ...
                if self.time_step % TARGET_UPDATE_INTERVAL == 0:
                    self.brain.update_target_network()
